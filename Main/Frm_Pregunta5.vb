Public Class Frm_Pregunta5
    ...
    Private Sub Btn_1_Click(sender As Object, e As EventArgs) Handles Btn_1.Click
        If Btn_1.Text = "Everest" Then
            count_function.Contar_Correcta()
            MsgBox("Su respuesta es correcta")
            MsgBox("Su puntaje es de: " + Puntaje.ToString)
            Me.Hide()
            MsgBox(Trivia_Game.nombre + " su puntaje final es de: " + Puntaje.ToString + "/5")
            If MessageBox.Show("Desea volver a intetarlo?", "Confirmar", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.No Then
                Application.Exit()
            Else
                Application.Restart()
            End If
